                ...
                Repeater {
                    ...
                    Item {
                        ...
                        Item {
                            ...
                            EditOverlay {
                                id: nativeEditOverlay
                                anchors.fill: parent
                                visible: pageImage.status === Image.Ready
                                         && root.editModeEnabled
                                         && root.editTool === "text"
                                z: 3
                                editableElements: root.pageTextBlocks(pageFrame.pageIndex)
                                selectedElementId: root.activeTextDraft
                                                   ? String(root.activeTextDraft.stableElementId
                                                            || root.activeTextDraft.blockKey
                                                            || root.activeTextDraft.id
                                                            || "")
                                                   : ""
                                ...
                                onSelectionChanged: function(element) {
                                    ...
                                    root.activateTextBlock(pageFrame.pageIndex, element)
                                }
                            }
                            ...
                            TapHandler {
                                ...
                                enabled: root.editModeEnabled && (root.editTool === "text" || root.editTool === "freeText")
