...
#include "../../../../src/backend/DesktopIntegration.h"
...
namespace {
struct qt_meta_tag_ZN18DesktopIntegrationE_t {};
} // unnamed namespace
...
Q_CONSTINIT static const uint qt_meta_data_ZN18DesktopIntegrationE[] = {
...
Q_CONSTINIT const QMetaObject DesktopIntegration::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18DesktopIntegrationE.offsetsAndSizes,
    qt_meta_data_ZN18DesktopIntegrationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18DesktopIntegrationE_t,
        // Q_OBJECT / Q_GADGET
...
void *DesktopIntegration::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18DesktopIntegrationE.stringdata0))
